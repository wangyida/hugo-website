...
%----------------------------------------------------------------------------------------
\photo[circle,noedge,left]{Photo_home}
\name{Yida}{WANG}
\address{Lillweg 13, Munich, Germany}
%\mobile{(+49) 178-127-9929}

\homepage{\underline{wangyida.github.io}}
\github{wangyida}
\linkedin{yida-wang-910123}
\skype{wangyida123@outlook.com}
\email{yidawang.cn@gmail.com}
%\stackoverflow{6844155}{yida-wang}
%\twitter{@twit}

\position{Ph.D student{\enskip\cdotp\enskip} Chair for Computer Aided Medical Procedures \& Augmented Reality} % Your expertise/fields
%\quote{``Proudly Enrolled in PRIS Lab of BUPT."} % A quote or statement

\makecvfooter{\today}{Yida~~~Wang}{Résumé} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
